...
👉 Piensa en main.js como el director de orquesta.
Los demás archivos tocan instrumentos, pero no deciden la canción.
...
document.addEventListener('DOMContentLoaded', () => {                                           // Esto le dice al navegador: “espera a que todo el HTML se haya cargado completamente” antes de ejecutar el código dentro del () => { … }.
    ...
    showView('login-view');                                                                     // Esta es la llamada a la función showView que he tenido que declarar con anterioridad
